...
const addPurchases = (arr) => { //same as before
  let newArr = arr.reduce((value1,value2) =>{
    value1 = value1 + value2.purchasePrice;
    return value1;
  },0);
  return newArr;
};
...
const countNumberOfElements = (arr) => {//close to the one before but without the sec element. just + 1.
  let newArr = arr.reduce((value)=>{
    value = value + 1;
    return value;
  },0);
  return newArr;
...
const returnNames = (arr) => {
  let newArr = arr.reduce((value1,value2,index) => {
    value1[index] = value2.name;
    return value1;
  },[]);
  return newArr;
};
...
const reversedString = (str) => {
  ...
  let reversedString =newArr.reduce((reversed,character) => {
